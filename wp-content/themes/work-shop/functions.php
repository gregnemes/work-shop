...
function theme_scripts() {
    ...
    //wp_register_script( 'jquery-mobile', get_template_directory_uri() . '/_/js/jquery.mobile.js');
    ...
    //wp_register_script( 'cycle', get_template_directory_uri() . '/_/js/cycle.js'); 
    //wp_register_script( 'cycle-center', get_template_directory_uri() . '/_/js/cycle-center.js');  
    //wp_register_script( 'cycle-swipe', get_template_directory_uri() . '/_/js/cycle-swipe.js');     
